...
Version  : 6.0.2
Release  : 17
URL      : https://cran.r-project.org/src/contrib/gamlss.data_6.0-2.tar.gz
Source0  : https://cran.r-project.org/src/contrib/gamlss.data_6.0-2.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1649433103

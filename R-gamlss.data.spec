...
%description
# GAMLSS-data
Contains all data used in GAMLSS book and demos

%prep
%setup -q -n gamlss.data
pushd ..
cp -a gamlss.data buildavx2
popd
pushd ..
cp -a gamlss.data buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710611337
